...
/*   Updated: 2019/10/29 22:54:25 by moguy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	static bool		g_valid_ld[ARG_MAX][ARG_MAX][ARG_MAX] = {
		[ARG_DIR][ARG_REG][ARG_NONE] = true,
		[ARG_IND][ARG_REG][ARG_NONE] = true
	};
	static bool		g_valid_lld[ARG_MAX][ARG_MAX][ARG_MAX] = {
		[ARG_IND][ARG_REG][ARG_NONE] = true,
		[ARG_DIR][ARG_REG][ARG_NONE] = true
	};
	static bool		g_valid_st[ARG_MAX][ARG_MAX][ARG_MAX] = {
		[ARG_REG][ARG_IND][ARG_NONE] = true,
		[ARG_REG][ARG_REG][ARG_NONE] = true
	};
